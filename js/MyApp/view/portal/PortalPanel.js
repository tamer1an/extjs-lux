/**
 * @class MmcApp.view.portal.PortalPanel
 * @extends Ext.panel.Panel
 * A {@link Ext.panel.Panel Panel} class used for providing drag-drop-enabled portal layouts.
 */
Ext.define('MmcApp.view.portal.PortalPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.portalpanel',

    requires: ['MmcApp.view.portal.PortalColumn'],
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('MmcApp.view.portal.PortalDropZone', this, this.dropConfig);
    },
